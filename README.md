...
## Publicar no Vercel (grÃ¡tis)
1. Crie um repositÃ³rio pÃºblico em https://github.com/new
2. No PowerShell:
   cd "C:\Users\SEU_USUARIO\Documents\advogado-solo"
   git init
   git add .
...
4. Acesse: https://SEU_USUARIO.vercel.app/meu-escritorio

## DomÃ­nio prÃ³prio (opcional)
1. Compre o domÃ­nio no Registro.br
2. GitHub: Settings > Pages > Custom domain
3. No Registro.br: aponte CNAME para SEU_USUARIO.vercel.app
